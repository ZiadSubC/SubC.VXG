...
namespace Veg.Mediacapture.Sdk.Render {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']"
	[global::Android.Runtime.Register ("veg/mediacapture/sdk/render/EglCore", DoNotGenerateAcw=true)]
	public sealed partial class EglCore : global::Java.Lang.Object {
		// Metadata.xml XPath field reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/field[@name='FLAG_RECORDABLE']"
		[Register ("FLAG_RECORDABLE")]
		public const int FlagRecordable = (int) 1;

		// Metadata.xml XPath field reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/field[@name='FLAG_TRY_GLES3']"
		[Register ("FLAG_TRY_GLES3")]
		public const int FlagTryGles3 = (int) 2;

		static readonly JniPeerMembers _members = new XAPeerMembers ("veg/mediacapture/sdk/render/EglCore", typeof (EglCore));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/constructor[@name='EglCore' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/constructor[@name='EglCore' and count(parameter)=2 and parameter[1][@type='android.opengl.EGLContext'] and parameter[2][@type='int']]"
		...
		public unsafe int GlVersion {
			// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='getGlVersion' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='createOffscreenSurface' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='createWindowSurface' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='isCurrent' and count(parameter)=1 and parameter[1][@type='android.opengl.EGLSurface']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='logCurrent' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='makeCurrent' and count(parameter)=1 and parameter[1][@type='android.opengl.EGLSurface']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='makeCurrent' and count(parameter)=2 and parameter[1][@type='android.opengl.EGLSurface'] and parameter[2][@type='android.opengl.EGLSurface']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='makeNothingCurrent' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='queryString' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='querySurface' and count(parameter)=2 and parameter[1][@type='android.opengl.EGLSurface'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='release' and count(parameter)=0]"
		[Register ("release", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='releaseSurface' and count(parameter)=1 and parameter[1][@type='android.opengl.EGLSurface']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='setPresentationTime' and count(parameter)=2 and parameter[1][@type='android.opengl.EGLSurface'] and parameter[2][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='EglCore']/method[@name='swapBuffers' and count(parameter)=1 and parameter[1][@type='android.opengl.EGLSurface']]"
