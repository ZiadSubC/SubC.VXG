...
namespace Veg.Mediacapture.Sdk.Render {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']"
	[global::Android.Runtime.Register ("veg/mediacapture/sdk/render/GlUtil", DoNotGenerateAcw=true)]
	public partial class GlUtil : global::Java.Lang.Object {

		// Metadata.xml XPath field reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/field[@name='IDENTITY_MATRIX']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/field[@name='TAG']"
		[Register ("TAG")]
		public const string Tag = (string) "GLCore";

		static readonly JniPeerMembers _members = new XAPeerMembers ("veg/mediacapture/sdk/render/GlUtil", typeof (GlUtil));
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='checkGlError' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='checkLocation' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='createFloatBuffer' and count(parameter)=1 and parameter[1][@type='float[]']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='createImageTexture' and count(parameter)=4 and parameter[1][@type='java.nio.ByteBuffer'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='createProgram' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='loadShader' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='veg.mediacapture.sdk.render']/class[@name='GlUtil']/method[@name='logVersionInfo' and count(parameter)=0]"
