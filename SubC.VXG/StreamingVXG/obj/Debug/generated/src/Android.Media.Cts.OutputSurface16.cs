...
namespace Android.Media.Cts {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']"
	[global::Android.Runtime.Register ("android/media/cts/OutputSurface16", DoNotGenerateAcw=true)]
	public partial class OutputSurface16 : global::Android.Media.Cts.OutputSurface {
		// Metadata.xml XPath field reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/field[@name='LOG_LEVEL']"
		[Register ("LOG_LEVEL")]
		public const int LogLevel = (int) 4;

		static readonly JniPeerMembers _members = new XAPeerMembers ("android/media/cts/OutputSurface16", typeof (OutputSurface16));
		...
		protected OutputSurface16 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/constructor[@name='OutputSurface16' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe OutputSurface16 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/constructor[@name='OutputSurface16' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register (".ctor", "(II)V", "")]
		public unsafe OutputSurface16 (int width, int height) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Android.Media.Cts.OutputSurface16> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Surface);
		}
#pragma warning restore 0169

		public override unsafe global::Android.Views.Surface Surface {
			// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='getSurface' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override unsafe global::Android.Graphics.SurfaceTexture SurfaceTexture {
			// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='getSurfaceTexture' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override unsafe int TextureId {
			// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='getTextureId' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='awaitNewImage' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='changeFragmentShader' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='drawImage' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='makeCurrent' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='onFrameAvailable' and count(parameter)=1 and parameter[1][@type='android.graphics.SurfaceTexture']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.media.cts']/class[@name='OutputSurface16']/method[@name='release' and count(parameter)=0]"
